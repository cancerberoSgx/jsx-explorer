...
export const jsxColorsClasses: JsxColorsClass[] = [
  {
    ...
    description:
      'Text in JSX elements body. THe equivalent to HTMLTextNode. For example the expression `<i>hello</i>` has the JSXText `hello`',
  },
...
.${ClassName['JsxSelfClosingElement']}.${ClassName['Identifier']}
...

  {
    ...
    description:
      'The tag name of intrinsic JSX elements (those tagname starting in lower case). The element can be any of opening, closing or self closing. ',
    value: [ClassName['JSXIntrinsicElementChild'], ClassName['Identifier']],
    selectorMode: 'intersection',
  },
  {
    name: ClassName['JsxNonIntrinsicElementTagName'],
    description:
      'The tag name of intrinsic JSX elements (those with tag name starting in lower case). The element can be any of opening, closing or self closing. ',
    value: [ClassName['JSXNonIntrinsicElementChild'], ClassName['Identifier']],
    selectorMode: 'intersection',
  },
  ...
  },
  {
    ...
    description:
      'The right-size - initialized expression of an attribute, for example `"foo"` in the expression `<div id="foo"`',
    selector: `.${ClassName['JsxAttribute']}.${ClassName['Identifier']}`,
  },
...

  {
    ...
    value: [ClassName['JsxAttribute'], ClassName['EqualsToken']],
    selectorMode: 'intersection',
  },
  {
    ...
    value: [ClassName['JsxExpression'], ClassName['JsxSpreadAttribute'], ClassName['JsxSpreadAttribute']],
    selectorMode: 'union',
  },
  {
  ...
  },
  {
    ...
    value: [ClassName['JSXTagSlashTokenClosingElement'], ClassName['JSXTagSlashTokenSelfClosingElement']],
    selectorMode: 'union',
  },
  {
...

  {
    ...
    value: [ClassName['JSXTagLessThanTokenOpeningElement'], ClassName['JSXTagGreaterThanTokenOpeningElement']],
    selectorMode: 'union',
  },
  {
...

  {
    ...
    description:
      'Parent JSX Element node that contains an entire tag, with attributes, children, text and the closing tag. etc',
  },
  ...
  // fragments
  {
    ...
    value: [ClassName['JsxOpeningFragment'], ClassName['JsxClosingFragment']],
    selectorMode: 'union',
  },
  {
    name: ClassName['JSXOpeningFragmentToken'],
    description: `The '<', '>' and '/' characters in a JSX Fragment expression like '<>hello</>'`,
    value: [ClassName['JsxOpeningFragment']],
    selectorMode: 'intersection',
  },
  {
    name: ClassName['JSXClosingFragmentToken'],
    description: `The '<', '>' and '/' characters in a JSX Fragment expression like '<>hello</>'`,
    value: [ClassName['JsxClosingFragment']],
    selectorMode: 'intersection',
  },
]
