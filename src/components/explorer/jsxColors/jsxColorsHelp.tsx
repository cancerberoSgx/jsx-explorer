...
export const Help = () => (
  <article className="content">
    ...
    <p>
      Visualize the Language Abstract syntax tree playing with existing skins, and when you are ready go and create your
      own syntax highlight theme.
    </p>
    <p>
      {' '}
      have 100% control on Use the menu below to learn how to use it, experiment existing JSx syntax themes and finally
      make your own!
    </p>
    <p>
      Hope you learn something about JSX syntax while visualizing its parts, and don't worry playing with different font
      sizes , decorations, colors, etc (nobody is watching)
    </p>
    ...
    <ul>
      {jsxColorsClasses.map(c => (
        <li>
          ...
          <br />
          Selector: <code>{buildSelectorFor(c)}</code>
        </li>
      ))}
    </ul>
  </article>
